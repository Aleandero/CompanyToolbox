    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="title col-12 col-md-9">
                <h3 class="align-center mb-4 display-2"><strong>Assistance in implementation</strong></h3>
                <h4 class="align-center display-7">Do you have an idea to improve your business? Write to us we will try to help you. So your employees will be able to use it freely on any device.</h4>
...
<section class="image3 cid-s48upRUlSD" >
    ...
    <div class="container">
        <div class="row justify-content-center">     
            <img src="assets/images/mbr-1916x1045.png">
        </div>
    </div>
</section>
